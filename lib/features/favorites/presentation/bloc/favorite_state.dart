...
final class DeleteFromFavoritesFailure extends FavoriteState {
  ...
  const DeleteFromFavoritesFailure({required this.message});
}

final class DeleteFromFavoritesSuccess extends FavoriteState {}


final class GetFavoriteCategoryFavoritesLoading extends FavoriteState {}
final class GetFavoriteCategoryFavoritesFailure extends FavoriteState {
  final String message;

  const GetFavoriteCategoryFavoritesFailure({required this.message});
}
final class GetFavoriteCategoryFavoritesSuccess extends FavoriteState {
  final FavoriteCategoryFavoritesDTO response;

  const GetFavoriteCategoryFavoritesSuccess({required this.response});
}